...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Movie.recommend_comments'
        db.add_column('watchlist_movie', 'recommend_comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Movie.recommend_comments'
        db.delete_column('watchlist_movie', 'recommend_comments')
    ...
    models = {
        'watchlist.movie': {
            ...
            'recommend_comments': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
